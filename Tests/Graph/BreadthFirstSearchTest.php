 ...
 * @author flo
 */
class BreadthFirstSearchTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        $this->graph = new BreadthFirstSearch(new Digraph());
    }
    ...
    private function recursivCreateTree($level, Vertex $parent)
    {
        if ($level > 0) {
